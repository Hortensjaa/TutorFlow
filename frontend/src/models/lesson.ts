// To parse this data:
//
//   import { Convert, Lesson } from "./file";
//
//   const lesson = Convert.toLesson(json);
//
...
export class Convert {
    public static toLesson(json: string): Lesson {
        return cast(JSON.parse(json), r("Lesson"));
    }

    public static lessonToJson(value: Lesson): string {
        return JSON.stringify(uncast(value, r("Lesson")), null, 2);
    }
}
